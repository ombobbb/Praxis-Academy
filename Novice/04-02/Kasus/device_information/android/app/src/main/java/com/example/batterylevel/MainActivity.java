        ...
        if (call.method.equals("getBatteryLevel")) {
          ...
          if (batteryLevel != -1) {
            String data =
                    ...
                    "OSName = " + Utilities.OSNAME + " \n" +
                    "OSVersion = " + Utilities.OSVERSION + " \n" +
                    "Release = " + Utilities.RELEASE + " \n" +
                    "Model = " + Utilities.MODEL + " \n " +
                    "Product = " + Utilities.PRODUCT + " \n " +
                    "Brand = " + Utilities.BRAND + " \n " +
                    "Display = " + Utilities.DISPLAY + " \n " +
                    "CPU_ABI = " + Utilities.CPU_ABI + " \n " +
                    "CPU_ABI2 = " + Utilities.CPU_ABI2 + " \n " +
                    "Unknown = " + Utilities.UNKNOWN + " \n " +
                    "Hardware = " + Utilities.HARDWARE + " \n " +
                    "ID = " + Utilities.ID + " \n " +
                    "Manufactur = " + Utilities.MANUFACTURER + " \n " +
                    "Serial = " + Utilities.SERIAL + " \n " +
                    "User = " + Utilities.USER + " \n " +
                    "Host = " + Utilities.HOST + " \n " ;
